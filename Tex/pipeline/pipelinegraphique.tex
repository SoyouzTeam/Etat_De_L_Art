...
Chaque vertex a reçu divers paramètre tels que la couleur et la la profondeur. Chaque fragment de chaque triangle va recevoir en attributs sa couleur, sa profondeur, sa position à l’écran, une transparence, par interpolation des trois vertices définis précédemment.
\end{itemize}
