...
\begin{itemize}
  ...
  \item Etape 2 : Calcul du rendu local (dans le champ de la caméra) et mise en place de texture des pixels de la facette.
  \item Etape 3 : Construction et rendu de l'image finale.\end{itemize}
...
Chaque vertex fournit des couleurs RGB pour définir comment il réagit à la lumière (réflexion, teinte, contraste…). On lui attribut alors une couleur RGB correspondant à son éclairage.
\\
