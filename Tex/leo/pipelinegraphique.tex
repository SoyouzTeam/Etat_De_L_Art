...
\\
\begin{center}
\includegraphics[width=14cm,height=40mm]{leo/images/pipeline1.png}
\end{center}
1999/2000 : La deuxieme génération (Transform \& lightin par le GPU)
\\
\begin{center}
\includegraphics[width=14cm,height=40mm]{leo/images/pipeline2.png} 
\end{center}
2001/2002 : Troisième génération (Vertex shader par le GPU)
\\
\begin{center}
\includegraphics[width=14cm,height=40mm]{leo/images/pipeline3.png}
\end{center}
2003 : Quatrième génération (Pixel shader par le GPU)
\\
\begin{center}
\includegraphics[width=14cm,height=40mm]{leo/images/pipeline4.png}
\end{center}
...
\\
\begin{center}
\includegraphics[width=12cm,height=50mm]{leo/images/T&L.png}
\end{center}
...
\begin{center}
\includegraphics[width=12cm,height=50mm]{leo/images/rasterOp.png}
\end{center}
