...
\subsubsubsection{World Transform}
...
\subsubsubsection{Vertex Blending}
Combinaison d’un ou plusieurs ensembles de sommets.\\
\subsubsubsection{View Transform}
...
\subsubsubsection{Vertex Fog}
Calcul de la couleur du brouillard pour chaque sommet.
\subsubsubsection{Lighting \& Materials}
...
\subsubsubsection{Projection Transform}
...
\subsubsubsection{Triangle setup ou pixellisation des triangles} 
...
\subsubsubsection{Per-pixel Fog}
