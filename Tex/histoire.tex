...
Dans cet exemple c'est donc le CPU qui va effectuer la demande de l'application en décomposant la ligne en pixels qui seront envoyés au GPU.\\
Ces calculs sont lourds pour le CPU, n'étant à l'époque composé que d'un coeur, celui ci n'est pas optimisé pour effectuer de nombreux de calcul en peu de temps.
...
Ici, c'est le GPU qui va calculer tous les pixels de la ligne d'après les consignes du CPU avant de les afficher à l'écran.
