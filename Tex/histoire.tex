...
\section{Différences entre le CPU et le GPU}
...
\begin{itemize}
	...
	\item	Détient une mémoire qui permet d'éviter de recharger des images avec le CPU pour chaque calcul.
\end{itemize}
...
\\Pour notre projet, le GPU est très utile, car il permet une sauvegarde de l'image qui réduit les interactions CPU-GPU et des calculs parallélisés.
